 ...
 * lives in `libs/act-pg/bench/notify-perf.scenario.bench.ts`
 * (cross-process) and `libs/act-pg/bench/reaction-latency.scenario.bench.ts`
 * (single-process).
 *
 * Run:
 *
 *   pnpm bench:scenarios libs/act/bench/reaction-latency.scenario.bench.ts
 */
import { z } from "zod";
