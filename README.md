...
| Package | Description |
|---|---|
| <nobr>[@rotorsoft/act-inspector](https://github.com/rotorsoft/act-root/tree/master/packages/inspector)</nobr><br>_web app_ | Event sourcing observatory — connect to any Act PostgreSQL store and inspect events in real time. Event log, SVG timeline, stream inspector, correlation explorer, drain monitor with live polling. |
