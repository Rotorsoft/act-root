...
| [@rotorsoft/act&#x2011;crypto](https://github.com/rotorsoft/act-root/tree/master/libs/act-crypto)<br>[![npm](https://img.shields.io/npm/v/@rotorsoft/act-crypto.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-crypto)&nbsp;[![downloads](https://img.shields.io/npm/dm/@rotorsoft/act-crypto.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-crypto) | Authenticated envelope encryption (AES-256-GCM, versioned wire format) for adapters that want column-level encryption with operator-controlled keys. |
...
| [@rotorsoft/act&#x2011;ops](https://github.com/rotorsoft/act-root/tree/master/libs/act-ops)<br>[![npm](https://img.shields.io/npm/v/@rotorsoft/act-ops.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-ops)&nbsp;[![downloads](https://img.shields.io/npm/dm/@rotorsoft/act-ops.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-ops) | Operational primitives for Act apps and act-independent receivers — idempotency, retry-budget sizing, poison-message classification. No peer dep on `@rotorsoft/act`, so non-Act consumers can speak the same contract without the orchestrator. |
...
| [@rotorsoft/act&#x2011;otel](https://github.com/rotorsoft/act-root/tree/master/libs/act-otel)<br>[![npm](https://img.shields.io/npm/v/@rotorsoft/act-otel.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-otel)&nbsp;[![downloads](https://img.shields.io/npm/dm/@rotorsoft/act-otel.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-otel) | Prometheus metrics bridge over the lifecycle events. |
| [@rotorsoft/act&#x2011;notify](https://github.com/rotorsoft/act-root/tree/master/libs/act-notify)<br>[![npm](https://img.shields.io/npm/v/@rotorsoft/act-notify.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-notify)&nbsp;[![downloads](https://img.shields.io/npm/dm/@rotorsoft/act-notify.svg?style=flat-square&label=)](https://www.npmjs.com/package/@rotorsoft/act-notify) | Notify-broker decorator — ride Redis (or any broker) for cross-process wakeups. |
