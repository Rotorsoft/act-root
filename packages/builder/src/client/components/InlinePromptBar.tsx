    ...
    <div className="flex shrink-0 items-center gap-2 border-b border-zinc-800 bg-zinc-925 px-4 py-1.5">
      ...
      <div className="flex flex-col gap-1">
        ...
        <button
          ...
          className="flex items-center justify-center gap-1 rounded-md bg-purple-600 px-3 py-1 text-[10px] font-medium text-white transition hover:bg-purple-500 disabled:opacity-50"
        >
          {generating ? (
